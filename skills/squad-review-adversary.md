...
description: "Stress-tests a converged review from outside its frame, surfacing off-checklist gaps and frame-level mistakes the review-critic could not see. Use after the review-critic returns SATISFIED with action submit, before the lead routes to the next phase or delivery."
...
The review-critic operates against named checks per @skill:squad-review-critic and `skills/references/squad-review-critic-checklist.md`: structural completeness, finding quality, evidence quality, proof discipline, routing and authority. It catches issues on those checks. It misses issues that do not fit any check. Your search target is exactly the off-check space.
