---
name: squad-triage
description: "Classifies a squad lifecycle requirement by risk, boundaries, and required gates. Use in Phase 0 of a squad run, during re-triage, or when explicitly reviewing squad triage flags, not for ordinary task starts."
metadata:
  skillcatalog/display_name: "Squad Triage"
...
- Treating re-triage as optional. An escalation trigger fires to re-triage is mandatory.
