...
description: "Stress-tests a converged plan from outside its frame, surfacing off-checklist gaps and frame-level mistakes after plan-critic returns SATISFIED. Use once per converged plan, before the lead accepts it."
