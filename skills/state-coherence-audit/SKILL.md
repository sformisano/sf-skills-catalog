...
description: "Find cloned, snapshotted, or cached in-memory runtime state that can silently diverge from the source of truth after mutations."
metadata:
  skillcatalog/display_name: "State Coherence Audit"
